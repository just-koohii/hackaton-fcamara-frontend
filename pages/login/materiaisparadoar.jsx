    ...
    return (        
        ...
        >
          <Grid xs={12} md={12} className={classes.form}>
            <Typography variant="h4">Fulano, digite seu CEP para localizarmos escolas próximas a você:</Typography>
          </Grid>
          <Grid xs={12} md={12} className={classes.form}>
            <TextField
            ...
            />
            <Button variant="contained" color="primary" href="../listaescolas" className={classes.button}>
                Pesquisar
            </Button>
          </Grid>
        <Grid xs={12} md={12} className={classes.form}>
